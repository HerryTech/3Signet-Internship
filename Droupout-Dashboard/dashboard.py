...
file_name = "Droupout-Dashboard/cleaned_transformed_dataset.csv"  # Update path
...
with col1:
    fig = px.pie(filter_data, names='Target', title='Target Status Distribution', hole = 0.5, template="seaborn")
